...
function reducer(state, action) {
  console.log("Reducer called with action:", action); // Log every action
...
function CitiesProvider({ children }) {
  ...
  useEffect(() => {
    ...
    if (cities.length > 0) {
      console.log("Cities already fetched, skipping fetch.");
      return;
    }
  ...
  async function deleteCity(id) {
    ...
    try {
      ...
      dispatch({ type: "rejected", payload: "error while deleteing data" });
    }
  }
